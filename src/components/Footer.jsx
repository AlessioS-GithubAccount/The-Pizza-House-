...
export default function Footer() {
  return (
    <footer
      className={`container-fluid position-relative py-5 text-white ${styles.footerRoot} ${styles.videoBackground}`}
    ...
    >
      ...
      <div className="row g-4">
        ...
        <section className={`col-12 col-md-6 ${styles.whereWeAre}`}>
          ...
          {/* wrapper che limita larghezza e centra la mappa */}
          <div className={styles.mapWrap}>
            <iframe
              title="OpenStreetMap"
              className={`rounded shadow ${styles.mapFrame}`}
          ...
          <div className="mt-2 text-center">
            <a
              ...
              href="https://www.openstreetmap.org/#map=12/44.9169/8.6037"
              target="_blank"
              rel="noreferrer"
            >
